...
public class AppRate implements OnClickListener, OnCancelListener {
	...
	private void showDefaultDialog() {
		...
		String message = MainActivity.message1 + getApplicationName(hostActivity.getApplicationContext()) + MainActivity.message2;
		String rate = MainActivity.rate;
		String remindLater = MainActivity.remindLater;
		String dismiss = MainActivity.dismiss;
	...
	public void onClick(DialogInterface dialog, int which) {
		...
		case DialogInterface.BUTTON_POSITIVE:
			try
			{
				...
				Toast.makeText(hostActivity, MainActivity.mContext.getString(R.string.apprate_gp_isnt_installed), Toast.LENGTH_SHORT).show();
			}
